...
const DetBlog = ({ blog }) => {
    ...
    return (
        <MainLayout>
            <div className="blog-header relative rounded-sm overflow-hidden mb-8 shadow-lg">
                {blog.image && (
                    <img
                        src={`/storage/${blog.image}`}
                        alt={blog.title}
                        className="blog-header-img w-full h-96 object-cover blur-md"
                    />
                )}
            ...
            <section className="blog-detail-section px-4 py-8">
                ...
                <div className="blog-container max-w-screen-2xl mx-auto">
                    ...
                    {/* Summary */}
                    <div className="blog-summary my-12 p-6 bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl border border-purple-100">
                    ...
                    {/* Share Section */}
                    <div className="blog-share my-12">
                        ...
                        <div className="share-buttons flex flex-wrap gap-3">
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="px-4 py-2 bg-[#1DA1F2] text-white rounded-lg hover:bg-[#1A91DA] transition flex items-center gap-2"
                            >
                                <svg
                                    className="w-5 h-5"
                                    fill="currentColor"
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="px-4 py-2 bg-[#25D366] text-white rounded-lg hover:bg-[#1DA851] transition flex items-center gap-2"
                            >
                                <svg
                                    className="w-5 h-5"
                                    fill="currentColor"
                            ...
                            <button
                                onClick={copyLink}
                                className="px-4 py-2 bg-gradient-to-r from-[#a855f7] to-[#6366f1] text-white rounded-lg hover:opacity-90 transition flex items-center gap-2"
                            >
                                <svg
                                    className="w-5 h-5"
                                    fill="none"
