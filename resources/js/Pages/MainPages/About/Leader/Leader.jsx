    ...
    return (
        <div className="my-20 md:my-32 px-4">
            <div className="max-w-7xl mx-auto">
                <h2 className="text-4xl md:text-5xl font-bold mb-3 text-center text-gray-900">
                    Meet Our Team
                </h2>
                <p className="text-center mb-16 text-xl text-gray-600">
                    Team Profile
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10">
                    {profiles?.map((profile, index) => {
                        ...
                        return (
                            <div
                                key={index}
                                className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-3 group"
                            >
                                ...
                                <div className="pt-7 pb-8 px-6">
                                    <h3 className="text-2xl font-bold text-center text-gray-800 dark:text-white mb-2 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">
