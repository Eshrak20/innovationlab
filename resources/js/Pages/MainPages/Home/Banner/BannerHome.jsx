    ...
    return (
        <div className="relative w-full h-screen overflow-hidden text-white flex items-center justify-center">
            ...
            <div className="relative text-center z-10">
                <h2 className="-mt-44 text-xl md:text-4xl 2xl:text-6xl font-extrabold uppercase text-white bg-black bg-opacity-70 p-8 rounded-xl shadow-2xl shadow-blue-800/50 transition duration-500 ease-in-out hover:scale-95">
                ...
                <div className="absolute top-[170px] left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
                    <motion.h1
